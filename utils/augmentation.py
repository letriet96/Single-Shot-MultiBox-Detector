...
def intersect(box_a, box_b):
    """
    args:
        box_a: Tensor, shape = (num_box, 4)
        box_b: Tensor, shape = (4)
    return:
        intersection area of box_b with every box in box_a
    """
    ...
    width = torch.clamp(x2 - x1 + 1, min=0)
    height = torch.clamp(y2 - y1 + 1, min=0)
