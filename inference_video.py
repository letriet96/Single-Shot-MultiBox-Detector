from lib import *
from model import SSD, non_max_suppression, decode
...
net = SSD(phase="inference", cfg=cfg, nms_thresh=0.45)
net_weights = torch.load("./data/weights/ssd300_mAP_77.43_v2.pth", map_location=device)
net.load_state_dict(net_weights)

img_path = "C:\\Users\\Administrator\\PycharmProjects\\Object-Detection-YOLO\\Videos\\traffic.mp4"
